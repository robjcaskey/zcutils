...
OUTDIR="$ROOT/bench-results/zcworkload-qemu-tap-2lane-mq-qd64-20260713T0815Z"
...
echo "host-harness-result: PASS two_vm_kvm=true tap_bridge=true virtio_queue_pairs=2 lanes=2 direct_userspace_memory_leaf=true frame_bytes=4096 representative=false"
