...
common_fan_env=(
  ...
  URING_PLAY_ZCNBLK_FAN_RESULT_ARENA=1
  URING_PLAY_ZCNBLK_FAN_RESULT_ARENA_SPIN=1
  URING_PLAY_ZCNBLK_FAN_RESULT_ARENA_SPIN_BUDGET=100000
  URING_PLAY_ZCNBLK_FAN_RESULT_ARENA_SLOTS=512
  URING_PLAY_ZCNBLK_FAN_RESULT_WAIT_POLICY=greedy
  URING_PLAY_ZCNBLK_FAN_RESULT_SPIN_BUDGET=100000
)
common_send_env=(
  URING_PLAY_PIN_CPUS=1
  URING_PLAY_SOCKET_BUFFER_BYTES=134217728
...
(
  ...
  export URING_PLAY_PIN_CPU_LIST=0-63
...
(
  export "${common_fan_env[@]}"
  export URING_PLAY_PIN_CPU_LIST=96-159
...
(
  ...
  export URING_PLAY_PIN_CPU_LIST=64-95
  export URING_PLAY_SOURCE_IP=172.31.41.87
...
(
  export "${common_send_env[@]}"
  export URING_PLAY_PIN_CPU_LIST=160-191
  export URING_PLAY_SOURCE_IP=172.31.41.126
