...
OUTDIR="$ROOT/bench-results/zcworkload-qemu-tap-2lane-mq-vhostpin-qd64-20260713T0845Z"
...
pin_vhost_vm target "$TARGET_PID" 21 22 "$OUTDIR/host-thread-map.log"
pin_vhost_vm client "$CLIENT_PID" 26 27 "$OUTDIR/host-thread-map.log"
...
echo "host-harness-result: PASS two_vm_kvm=true tap_bridge=true virtio_queue_pairs=2 vhost_smt_paired=true lanes=2 direct_userspace_memory_leaf=true frame_bytes=4096 representative=false"
