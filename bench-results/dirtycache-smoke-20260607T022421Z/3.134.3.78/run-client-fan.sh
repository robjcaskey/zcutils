...
common_send_env=(
  ...
  URING_PLAY_ZCNBLK_BATCH_DEPTH=$BATCH
  URING_PLAY_ZCNBLK_READ_WINDOW=4096
  URING_PLAY_ZCNBLK_WRITE_WINDOW=4096
...
(
  ...
  export URING_PLAY_PIN_CPU_LIST=8-15
  export URING_PLAY_SOURCE_IP=172.31.41.87
  export URING_PLAY_ROUTE_PROBE=1
  export URING_PLAY_EXPECT_ROUTE_DEV=lo
...
(
  export "${common_send_env[@]}"
  export URING_PLAY_PIN_CPU_LIST=104-111
  export URING_PLAY_SOURCE_IP=172.31.41.126
  export URING_PLAY_ROUTE_PROBE=1
  export URING_PLAY_EXPECT_ROUTE_DEV=lo
