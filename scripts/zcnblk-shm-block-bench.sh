...
BLOCK_CQE_HOT_POLL_PROGRESS_SPINS="${URING_PLAY_BLOCKBENCH_CQE_HOT_POLL_PROGRESS_SPINS:-4096}"
...
LEAF_ADAPTIVE_SPIN_MAX="${URING_PLAY_ZCNBLK_WAL_LEAF_ADAPTIVE_SPIN_MAX:-4096}"
...
WAL_OWNER_WORKER_SPINS="${URING_PLAY_ZCNBLK_SHM_OWNER_WORKER_SPINS:-4096}"
WAL_OWNER_WRITE_FILL_US="${URING_PLAY_ZCNBLK_SHM_OWNER_WRITE_FILL_US:-20}"
...
WAL_OWNER_FRAGMENT_RECORDS="${URING_PLAY_ZCNBLK_SHM_OWNER_FRAGMENT_RECORDS:-64}"
...

{
	...
	printf 'wal_lane_batch=%s representative_eligible=%s\n' \
		"$WAL_LANE_BATCH" true
	printf 'wal_owner_dispatch=%s wal_owner_extent_records=%s wal_owner_worker_spins=%s\n' \
	...
	printf 'wal_owner_write_fill_us=%s wal_owner_write_fill_min=%s wal_owner_pipeline_batches=%s\n' \
	...
	printf 'remote_recv_spins=%s leaf_spin_reads=%s leaf_spin_policy=%s leaf_spin_budget=%s leaf_adaptive_spin_min=%s leaf_adaptive_spin_max=%s leaf_adaptive_wait_ns=%s\n' \
	...
	printf 'remote_recv_policy=%s remote_recv_adaptive_spin_min=%s remote_recv_adaptive_spin_max=%s remote_recv_adaptive_wait_ns=%s\n' \
